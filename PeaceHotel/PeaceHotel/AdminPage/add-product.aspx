<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-product.aspx.cs" MasterPageFile="~/AdminPage/MasterPage/Nav.Master" Inherits="PeaceHotel.AdminPage.add_product" %>
                            ...
                            <div class="row formtype">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="amount" pattern="^\d+(?:\.\d{1,2})?$" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date" class="form-control" required placeholder="dd/mm/yyyy" value="" pattern="(31/(0[13578]|1[02])/(18|19|20)[0-9]{2})|((29|30)/(01|0[3-9]|1[1-2])/(18|19|20)[0-9]{2})|((0[1-9]|1[0-9]|2[0-8])/(0[1-9]|1[0-2])/(18|19|20)[0-9]{2})|(29/(02)/(((18|19|20)(04|08|[2468][048]|[13579][26]))|2000))">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
